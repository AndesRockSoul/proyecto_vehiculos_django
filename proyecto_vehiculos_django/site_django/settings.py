...
INSTALLED_APPS = [
    ...
    'vehiculo.apps.VehiculoConfig', # registro de la app en el proyecto
...
LOGIN_URL = '/home/'    #se declara la url de login
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [BASE_DIR / "static"]  #esto se agrega ara agregar la imagen
